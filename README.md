...
**Hello react rails** is an application meant to improve my new react on rails knowledge. Using Webpack with the jsbundling-rails gem
...
This projects aim is to help me understand the key features of React Rails applications.

- Create API endpoint for random greeting
- Render random greeting with react
...
#### Github
- Enter this url: [https://github.com/OkoyeCharles/hello-rails-react/](https://github.com/OkoyeCharles/hello-rails-react/) in your web browser.
...
```sh
  git clone github.com/OkoyeCharles/hello-rails-react/.git
  cd rails-recipe-app
```
...
- Run `npm run build` to integrate changes in React application.
